...
@Component({
  selector: 'app-newreferrallogistics',
  templateUrl: './newreferrallogistics.page.html',
  styleUrls: ['./newreferrallogistics.page.scss'],
})
export class NewreferrallogisticsPage implements OnInit {
  ...
  fetchprocedures(){
    this.calls.getrequest('/fetchprocedures/logistics').subscribe(async info => {
