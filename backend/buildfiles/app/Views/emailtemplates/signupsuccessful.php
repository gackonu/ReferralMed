                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <a href="<?= $frontendurl ?>/#/verifyaccount/<?= $token ?>" style="background:#20e277;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Verify Email</a>
                                        <p>If that does not work? copy the link below and paste it in any web browser of your choice</p>
                                        <a href="#"><?= $frontendurl ?>/#/verifyaccount/<?= $token ?></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height:40px;">&nbsp;</td>
